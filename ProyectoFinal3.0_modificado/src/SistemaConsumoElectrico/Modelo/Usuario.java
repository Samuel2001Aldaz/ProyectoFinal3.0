...
public abstract class Usuario extends Persona {
    ...
    // Ahora el usuario tendrá varios inmuebles
    ...
    public Usuario(String cedula, String nombre, String contraseña, Sector sector) throws DatoInvalidoException {

        this(cedula, nombre, contraseña, sector, Rol.USUARIO);

    }

    // Constructor para cualquier rol (Administrador o Usuario)
    public Usuario(String cedula, String nombre, String contraseña, Sector sector, Rol rol) throws DatoInvalidoException {
    ...
    public boolean eliminarInmueble(int idInmueble) {
        ...
        return inmuebles.removeIf(i -> i.getId() == idInmueble);
    ...
    public String obtenerListaInmuebles() {

        if (inmuebles.isEmpty()) {

            return "No existen inmuebles registrados.";
        ...
        for (Inmueble i : inmuebles) {
            ...
            texto.append("ID: ").append(i.getId()).append(" | Nombre: ").append(i.getNombre()).append(" | Tipo: ").append(i.getTipo()).append("\n");
