...
public class Inmueble {
    ...
    public Inmueble(
        ...
        if (nombre == null || nombre.trim().isEmpty()) {
            ...
            throw new DatoInvalidoException(
                    "El nombre del inmueble no puede estar vacío."
            );
    ...
    public boolean eliminarDispositivo(
            int idDispositivo
    ) {

        return dispositivos.removeIf(
                d -> d.getId() == idDispositivo
        );

    }

    public Dispositivo buscarDispositivo(
            int idDispositivo
    ) {
