...
public class Recomendador {
    ...
    public String generarRecomendaciones(Usuario usuario) {
        ...
        if (mayor != null) {
            ...
            texto.append("Sugerencia: reducir las horas de uso de " + mayor.getNombre() + " puede disminuir el consumo.\n");
        ...
        if (consumo > limite) {
            ...
            texto.append("El consumo supera el límite del sector " + usuario.getSector() + ".\n");
