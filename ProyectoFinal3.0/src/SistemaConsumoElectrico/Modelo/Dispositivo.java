...
public class Dispositivo implements CalculableConsumo {
    ...
    public Dispositivo(int id, String nombre, double potencia, int cantidad, double horasUsoDiarias) throws DatoInvalidoException {
    ...
    private void validarDatos(String nombre, double potencia, int cantidad, double horas) throws DatoInvalidoException {
    ...
    public void setHorasUsoDiarias(double horas) throws DatoInvalidoException {
        ...
        if(horas <=0 || horas>24){
            ...
            throw new DatoInvalidoException("Horas de uso inválidas");
        }

        this.horasUsoDiarias=horas;
    }

    public void setPotencia(double potencia) throws DatoInvalidoException {

        if(potencia<=0){

            throw new DatoInvalidoException("Potencia inválida");
        }
